...
TargetingSystem::TargetingSystem(EntityManager *entity_manager, SystemManager *system_manager,
                                 CollidersMap *colliders_map, EntityHandler *entity_handler)
...
void TargetingSystem::BreadthSearch(Entity *enemy, Entity *target) {
  ...
  if (colliders_map_->CellContains<EnemyComponent>(back_path.back()->from_->vec_)) {
