#ifndef INCLUDE_ROGUE_COMPONENTS_COLLIDER_COMPONENT_H_
#define INCLUDE_ROGUE_COMPONENTS_COLLIDER_COMPONENT_H_
...
#endif  // INCLUDE_ROGUE_COMPONENTS_COLLIDER_COMPONENT_H_
